...
class AC_OPF_test:     
    ...
    def Main_Program(self):
        ...
        # self.p = [7, 18, 57, 0.454524426301, 0.396392953866, 0.753182776033, 0.454524426301, 0.396392953866, 0.753182776033, 0.454524426301, 0.396392953866, 0.753182776033]
        # self.q = [7, 18, 57, 0.102628956156, 0.113827245348, 0.210779852551, 0.102628956156, 0.113827245348, 0.210779852551, 0.102628956156, 0.113827245348, 0.210779852551]
        # self.DemandRes_Price = [1, 2, 3, 4, 5, 0, 0, 0, 0, 0]
        # self.DemandRes_load = [1, 2, 3, 4, 5, 0, 0, 0, 0, 0]

        self.ip = [1, 2.3175313054, 2.3175313054, 2.3175313054]
        self.p = [7, 18, 57, 0.450879889844, 0.400222257777, 0.815839868149, 0.450879889844, 0.400222257777, 0.815839868149, 0.450879889844, 0.400222257777, 0.815839868149]
        self.q = [7, 18, 57, 0.158772737372, 0.123298079597, 0.253851830787, 0.158772737372, 0.123298079597, 0.253851830787, 0.158772737372, 0.123298079597, 0.253851830787]
        self.DemandRes_Price = [1, 2, 3, 4, 5, 0, 0, 0, 0, 0]
        self.DemandRes_load = [1, 2, 3, 4, 5, 0, 0, 0, 0, 0]
