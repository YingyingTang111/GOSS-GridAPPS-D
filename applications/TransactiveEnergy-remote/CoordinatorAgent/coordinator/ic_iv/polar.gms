...
$call gams "%filepath%polar_acopf.gms" --genPmin=%genPmin% --allon=%allon% --linelimits=%linelimits% --case="%case%" --obj=%obj% gdx=polartemp.gdx lo=3 --timeperiod=%timeperiod% reslim=3600 nlp=ipopth
$else.ICverbose
$call gams "%filepath%polar_acopf.gms" --genPmin=%genPmin% --allon=%allon% --linelimits=%linelimits% --case="%case%" --obj=%obj% gdx=polartemp.gdx lo=3 --timeperiod=%timeperiod% reslim=3600 nlp=ipopth
*--o=/dev/null > /dev/null
$endif.ICverbose
