...
$call gams "%filepath%ic_rect%sep%ic_xls2gdx.gms" --in="%filepath%ic_rect%sep%sol_%casename%.xlsx"

parameters ic_bus, ic_gen;

$GDXIN %filepath%ic_rect%sep%sol_%casename%.gdx
$LOAD ic_bus, ic_gen
$GDXIN
...
execute 'rm "%filepath%ic_rect%sep%sol_%casename%.gdx"' ;
